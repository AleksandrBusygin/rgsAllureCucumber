...
Когда выбрана услуга "Путешествия"
Когда выбрана конкретеная услуга "Страхование выезжающих за рубеж"
...
Когда выбрана усуга дополнительная услуга активного отдыха "Да"
